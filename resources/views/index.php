...
<html ng-app="app" ng-cloak>
  ...
  <body ng-controller="navController" class="hold-transition" ng-class="{'skin-blue side-mini':isAuthenticated(), 'login-page':!isAuthenticated()}">
    ...
    <script src="app/modules/user/auth/auth.js"></script>
    <script src="app/modules/navigation/nav.js"></script>
